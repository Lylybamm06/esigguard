...
def parse_browser_payload():
    ...
    print(f"   body_snippet      = {body_snippet[:50]}..." if body_snippet else "   body_snippet      = (vide)")
    ...
    print(f"   email_subject     = {email_data['email_subject'][:50]}..." if email_data['email_subject'] else "   email_subject     = (vide)")
    ...
    try:
        ...
        try:
            ...
            cursor.close()
            conn.close()
            print("   🔄 Statut mis à jour → processing")
